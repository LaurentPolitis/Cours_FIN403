...
- <img src="https://upload.wikimedia.org/wikipedia/commons/2/29/Minard.png" height="250px" width="800px" />
...
- <img src="image/pay_rolls.PNG" height="290px" width="490px" />
source "How to Lie With Statistics", 1954, *Huff*

## Science sous jacente les statistiques 
<img src="https://shrineodreams.files.wordpress.com/2013/01/huff1.jpg" height="450px" width="400px" />
source "How to Lie With Statistics", 1954, *Huff*
...
- Possibilité de créer des illustrations, applications web et même la présentation que vous lisez actuellement 
          <img src="image/run_Paris.png" height="200px" width="400px" /> 
...
![Import Dataset > from Local File](image/IDE5.PNG)

## Importer des données  sous R 

Import Dataset > from Local File
![Import Dataset > from Local File](image/IDE6.PNG)
